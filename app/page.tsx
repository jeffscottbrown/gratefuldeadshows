/**
 * Hero image prompt for AI generation (DALL-E / Midjourney / Stable Diffusion):
 *
 * "Colorful illustrated dancing Grateful Dead bears traveling around the globe as tourists,
 * visiting famous landmarks: the Eiffel Tower in Paris, Madison Square Garden in New York,
 * the St. Louis Gateway Arch, Red Rocks Amphitheatre in Colorado, and the Golden Gate Bridge
 * in San Francisco. Psychedelic vintage poster style with vibrant cosmic colors, starry sky,
 * warm golden tones, swirling patterns. Wide landscape format. No text."
 *
 * Place the generated image at: public/images/hero.png
 */
  ...
  return (
    <div>
      ...
      <section className="relative w-full overflow-hidden" style={{ minHeight: '420px' }}>
        ...
        {/* Replace /images/hero-placeholder.svg with /images/hero.png once AI image is generated.
            Prompt: "Colorful illustrated dancing Grateful Dead bears traveling the globe as tourists,
            visiting the Eiffel Tower, Madison Square Garden, St. Louis Gateway Arch, Red Rocks
            Amphitheatre, and Golden Gate Bridge. Psychedelic vintage poster style, vibrant cosmic
            colors, starry sky, warm golden tones, swirling patterns. Wide landscape. No text." */}
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center px-4 py-20">
          ...
          <p className="mt-4 text-lg md:text-xl text-gray-300 max-w-xl drop-shadow">
            A searchable archive of every concert — every city, every song, every year.
          </p>
        </div>
      </section>
      ...
      <section className="border-y border-dead-border bg-dead-card/60">
        <div className="mx-auto max-w-7xl px-4 py-4">
          <div className="flex flex-wrap justify-center divide-x divide-dead-border">
            ...
            <StatBadge value={fmt(stats.numberOfSongPerformances)} label="Performances" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {navCards.map((card) => (
            ...
            >
              ...
              <h2 className={`text-lg font-semibold ${card.accent} group-hover:text-white transition-colors`}>
                {card.label}
              </h2>
