    ...
    <div className="mx-auto max-w-4xl px-4 py-10">
      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-8">
        ...
        <div className="rounded-xl border border-dead-border bg-dead-card p-5">
          <h2 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3">Listen</h2>
        ...
        {releases.length > 0 && (
          <div className="rounded-xl border border-dead-border bg-dead-card p-5 flex-1">
            <h2 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3">Official Releases</h2>
