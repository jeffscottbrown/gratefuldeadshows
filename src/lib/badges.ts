...
export const BADGES: Record<string, BadgeInfo> = {
  "dicks-picks": {
    name: "Dick's Picks",
    abbr: "DiP",
    cls: "bg-rose-800 text-rose-100",
  },
  "daves-picks": {
    name: "Dave's Picks",
    abbr: "DaP",
    cls: "bg-blue-800 text-blue-100",
  },
  "road-trips": {
    name: "Road Trips",
    abbr: "RT",
    cls: "bg-green-800 text-green-100",
  },
  "download-series": {
  ...
  "may-1977": {
    name: "May 1977",
    abbr: "M77",
    cls: "bg-pink-800 text-pink-100",
  },
  "get-shown-the-light": {
    name: "Get Shown The Light",
    abbr: "GSL",
    cls: "bg-pink-700 text-pink-100",
  },
  "pacific-northwest": {
  ...
  "july-1978": {
    name: "July 1978",
    abbr: "J78",
    cls: "bg-yellow-700 text-yellow-100",
  },
  "spring-1990": {
    name: "Spring 1990",
    abbr: "S90",
    cls: "bg-lime-700 text-lime-100",
  },
  ...
  "listen-to-the-river": {
    ...
    abbr: "LtR",
    cls: "bg-cyan-800 text-cyan-100",
  },
  "in-and-out-of-the-garden": {
    name: "In And Out Of The Garden",
    abbr: "IOG",
    cls: "bg-violet-800 text-violet-100",
  },
  "giants-stadium": {
    name: "Giants Stadium",
    abbr: "GS",
  ...
  "saint-of-circumstance": {
    ...
    abbr: "SoC",
    cls: "bg-fuchsia-800 text-fuchsia-100",
  },
  "ready-or-not": {
    name: "Ready Or Not",
    abbr: "RoN",
    cls: "bg-rose-700 text-rose-100",
  },
  "lyceum-1972": {
    name: "Lyceum 1972",
    abbr: "Lyc",
...
export function getBadge(slug: string): BadgeInfo {
  return (
    BADGES[slug] ?? { name: slug, abbr: "?", cls: "bg-gray-700 text-gray-100" }
  );
}

export const COLLECTION_SLUGS = Object.keys(BADGES);
